...
const slideImage = [
  {
    url: "images/IMG1.jpg",
    caption:
      "Advocate Syed Malik-e-Ashtar Rizvi Senior Advocate Experience - 21 yrs of legal practice",
  },
  {
    url: "images/IMG6.jpg",
  ...
  return (
    <div className="w-full h-fit md:h-[800px] flex pl-2 pr-2 lg:pl-[8rem] lg:pr-[8rem] xl:pl-[20rem] xl:pr-[20rem] pt-24 gap-6 ">
      ...
      <div className="w-full">
        <Fade arrows={true} duration={2000} transitionDuration={1000}>
          {slideImage.map((slideImage, index) => (
            <div key={index}>
              <div
                className="div_style_team"
                style={{ backgroundImage: `url(${slideImage.url})` }}
              >
                <span
                  className="w-full font-serif text-center h-[200px]"
                  style={spanStyle}
                >
                  {slideImage.caption}
                </span>
