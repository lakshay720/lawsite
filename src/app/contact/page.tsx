...
const Contact = () => {
  const iframeSrc =
    "https://www.google.com/maps/embed/v1/place?q=Goldline%20Residency%2CC404%2C%20Ayodhya%20road%2C%20Lucknow&key=AIzaSyBdEcl5Loq-Ovedhjnx0ctsxbPu-y6Vwjw";
  ...
  return (
    <div className="w-full">
      ...
      <div className="pl-2 pr-2 md:pl-[8rem] md:pr-[8rem] lg:pl-[8rem] lg:pr-[8rem] xl:pl-[20rem] xl:pr-[20rem]">
        <span className="font-serif text-[56px] font-thin ">Contact</span>
